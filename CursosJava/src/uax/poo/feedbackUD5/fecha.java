...
/* constructor fecha sobrecargado con hh:mm:ss a 0 */
    ...
    public fecha(String fecha) {
        String[] separarFecha = fecha.split("/");//separamos el string con /
        ...
        System.out.println("Fecha introducida: " + dia + "/" + mes + "/" + anno);
    }

//metodos
    public static void main(String[] args) throws Exception{
        fecha fecha1 = new fecha(30, 6, 2015, 23, 59, 60);//segundo intercalar CORRECTO
        fecha fecha2 = new fecha(30, 1, 2023, 23, 59, 59);//fecha actual CORRECTA
        fecha fecha3 = new fecha(30, 1, 2023, 23, 59, 60);//fecha actual con ERROR en segundo
        fecha fecha4 = new fecha(30, 1, 2023, 23, 60, 59);//fecha actual con ERROR en minuto
        fecha fecha5 = new fecha(30, 1, 2023, 24, 59, 59);//fecha actual con ERROR en hora
        fecha fecha6 = new fecha(30, 13, 2023, 23, 59, 59);//fecha con ERROR en mes
        fecha fecha7 = new fecha(32, 1, 2023, 23, 59, 59);//fecha con ERROR en dia
        fecha fecha8 = new fecha(29, 2, 2020, 23, 59, 59);//año bisiesto CORRECTO
        fecha fecha9 = new fecha(29, 2, 2023, 23, 59, 59);//No bisiesto con ERROR
        fecha fecha10 = new fecha(31, 4, 2023, 23, 59, 59);//mes de 30 dias con ERROR
        fecha fecha11 = new fecha(14, 10, 1582, 23, 59, 59);//fecha anterior a 1582 con ERROR
        fecha fecha12 = new fecha(17, 6, 2023, 23, 59, 59);//fecha CORRECTA
        fecha fecha13 = new fecha(17, 7, 2023, 23, 59, 59);//fecha CORRECTA
    }


    /* Posterior devuelve true si la segunda fecha es posterior a la primera fecha. He incluido hasta los segundos*/

...
<!-- education -->
<section class="section position-relative" id="education">
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
    ...
    <div class="row">
      ...
      <div class="col-lg-10 mx-auto testimonial-slider">
        ...
        <div class="text-center testimonial-content">
          ...
          <p class="text-white mb-4">a<!--  PREGUNTA 5c--></p>
          <img class="img-fluid rounded-circle mb-4 d-inline-block" src="images/testimonial/client-1.png"
            alt="client-image">
          <h4 class="text-white">a<!--  PREGUNTA 5c--></h4>
          <h6 class="text-light mb-4">	a<!--  PREGUNTA 5c--></h6>
        </div>
      </div>
    </div>
  </div>
...
<!-- contact -->
<section class="section section-on-footer" data-background="images/backgrounds/bg-dots.png" id="contact">
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
      ...
      <div class="col-lg-8 mx-auto">
        <div class="  text-center p-5 shadow-down"><!-- EJERCICIO 3 --> 
          <h4>Contact Form</h4>
          <!-- EJERCICIO 2 -->
        </div>
      </div>
...
<footer class="bg-dark footer-section">
  ...
  <div class="border-top text-center border-dark py-5">
    <p class="mb-0 text-light">Copyright &copy;<script>
      ...
      </script>NOMBRE - NP - TIEMPO <!-- EJERCICIO 4 --> </a></p>
  </div>
</footer>
<!-- /footer -->
